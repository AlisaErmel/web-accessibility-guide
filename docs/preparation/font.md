...
Use a limited number of fonts and maintain **consistent typography** throughout the application to avoid confusion.

---

## Avoiding Character Confusion 🔠

To ensure readability and reduce misinterpretation, special attention was given to characters that are **commonly confused**. Below are some of the most critical groups of characters evaluated using 2 example fonts: `Noto Sans Mono` and `Oi`.
...
- **Good Example:**  
![Good Example](img/rn_good.JPG)

*Noto Sans Mono font from the Google Fonts: (https://fonts.google.com/noto/specimen/Noto+Sans+Mono)*

- **Bad Example:**  
![Bad Example](img/rn_bad.JPG)

*Oi font from the Google Fonts: (https://fonts.google.com/specimen/Oi)*
...
- **Good Example:**  
![Good Example](img/l_good.JPG)

*Noto Sans Mono font from the Google Fonts: (https://fonts.google.com/noto/specimen/Noto+Sans+Mono)*

- **Bad Example:**  
![Bad Example](img/l_bad.JPG)
...
- **Good Example:**  
![Good Example](img/o_good.JPG)

*Noto Sans Mono font from the Google Fonts: (https://fonts.google.com/noto/specimen/Noto+Sans+Mono)*

- **Bad Example:**  
![Bad Example](img/o_bad.JPG)
...
- **Good Example:**  
![Good Example](img/sz_good.JPG)

*Noto Sans Mono font from Google Fonts: (https://fonts.google.com/noto/specimen/Noto+Sans+Mono)*

- **Bad Example:**  
![Bad Example](img/sz_bad.JPG)

*Oi font from Google Fonts: (https://fonts.google.com/specimen/Oi)*
